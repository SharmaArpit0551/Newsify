import { useArticlesByCategoryQuery } from '@/features/api/categoryApi'
...
const Category = () => {
    ...
    const { data, isLoading, isError } = useArticlesByCategoryQuery(categoryId)
    ...
    return (
        <div className="text-center">
            <h1 className="font-bold text-2xl mt-20">Articles on related category</h1>
            <div className="my-5">
                {isLoading ? (
                    <MyLearningSkeleton />
                ) : data.articles.length === 0 ? (
                    <p className="my-20 text-lg font-semibold text-gray-600">
                        Articles on related tag is not present
                    </p>
                ) : (
